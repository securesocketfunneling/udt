...
#ifndef UDT_TIMER_DETAIL_DEADLINE_TIMER_SERVICE_HPP
#define UDT_TIMER_DETAIL_DEADLINE_TIMER_SERVICE_HPP
...
public:
    ...
    : private boost::asio::detail::noncopyable
  {
    ...
    typename boost::asio::detail::timer_queue<Time_Traits>::per_timer_data timer_data;
  };
...
private:
  ...
  void do_wait(const Duration& timeout, boost::system::error_code& ec)
  {
    ...
    boost::asio::detail::socket_ops::select(0, 0, 0, 0, &tv, ec);
#endif // defined(BOOST_ASIO_WINDOWS_RUNTIME)
  }

  // The queue of timers.
  boost::asio::detail::timer_queue<Time_Traits> timer_queue_;
...
#endif // UDT_TIMER_DETAIL_DEADLINE_TIMER_SERVICE_HPP
