...
#ifndef UDT_TIMER_BASIC_WAITABLE_TIMER_HPP
#define UDT_TIMER_BASIC_WAITABLE_TIMER_HPP
...
#include "udt/timer/waitable_timer_service.hpp"
...
template <typename Clock,
    ...
    typename WaitableTimerService = udt::timer::waitable_timer_service<
                                      Clock, WaitTraits, TimerSchedulerType> >
class basic_waitable_timer
  : public boost::asio::basic_io_object<WaitableTimerService>
{
public:
  /// The clock type.
  ...
  explicit basic_waitable_timer(boost::asio::io_service& io_service)
    : boost::asio::basic_io_object<WaitableTimerService>(io_service)
  {
  }
...
#endif // UDT_TIMER_BASIC_WAITABLE_TIMER_HPP
